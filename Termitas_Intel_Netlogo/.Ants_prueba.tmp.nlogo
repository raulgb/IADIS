...
to change-color ;; changes the color of the patches depending on the value
  ask patches [
    ifelse pheromones > ( min-pheromones )
    [                             ;;https://ccl.northwestern.edu/netlogo/docs/images/colors.jpg
      let aux max-pheromones / 5  ;;here we can see that if we add 5 to a normal color it will turn to black
      set pcolor ( color-pheromone + 5 ) - ( pheromones / aux )
    ]
    [
      set pcolor color-patch
      set pheromones 0
